...
export class CalendarsController {
  ...
  @ApiOperation({
    ...
    description:
      "Get busy times from a calendar. Example request URL is `https://api.cal.dre.app/v2/calendars/busy-times?timeZone=Europe%2FMadrid&dateFrom=2024-12-18&dateTo=2024-12-18&calendarsToLoad[0][credentialId]=135&calendarsToLoad[0][externalId]=skrauciz%40gmail.com`. Note: loggedInUsersTz is deprecated, use timeZone instead.",
  })
  async getBusyTimes(
