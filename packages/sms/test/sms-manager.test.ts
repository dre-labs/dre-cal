...
describe("SMSManager", () => {
  ...
  describe("sendSMSToAttendee", () => {
    ...
    test("should not send SMS if email is not @sms.cal.dre.app", async () => {
      const smsManager = new TestSMSManager(mockCalEvent);
    ...
    test("should check SMS rate limit only when phone number and @sms.cal.dre.app email are present", async () => {
      const smsManager = new TestSMSManager(mockCalEvent);
  ...
  describe("sendSMSToAttendees", () => {
    test("should check rate limit only for attendees with phone number and @sms.cal.dre.app email", async () => {
      const smsManager = new TestSMSManager(mockCalEvent);
