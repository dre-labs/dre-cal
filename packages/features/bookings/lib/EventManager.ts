...
export default class EventManager {
  ...
  constructor(user: EventManagerUser, eventTypeAppMetadata?: Record<string, any>) {
    ...
    this.calendarCredentials = appCredentials
      ...
      // see https://cal.dre.app/issues/11671#issue-1923600672
   ...
   *   This is useful for platform customers who manage their own calendar events but still want DRE Cal to create
