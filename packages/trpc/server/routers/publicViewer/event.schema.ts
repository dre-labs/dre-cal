...
export const ZEventInputSchema: z.ZodType<TEventInputSchema, z.ZodTypeDef, TEventInputSchemaInput> = z.object(
  {
    ...
    /**
     * Informs that the event request has been sent from a page that was reached by a redirect from non-org link(i.e. cal.dre.app/username redirected to acme.cal.dre.app/username)
